export declare const createCache: <Value = any, ErrorType = Error>(resolve: (key: string, ...args: any[]) => Promise<Value>, lruSize?: number) => Cache<Value, ErrorType>;
export declare type Cache<Value = any, ErrorType = Error> = {
    ...
    subscribe: (key: string, callback: CacheSubscribeCallback<CacheState<Value, ErrorType>>) => void;
    unsubscribe: (key: string, callback: CacheSubscribeCallback<CacheState<Value, ErrorType>>) => void;
};
...
export declare const useCache: <Value = any, ErrorType = Error>(cache: Cache<Value, ErrorType>, key: string, ...args: any[]) => [UseCacheState<Value, ErrorType>, () => Promise<CacheState<Value, ErrorType>>];
