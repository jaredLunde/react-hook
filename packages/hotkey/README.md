...
### `useHotkeys<T = HTMLElement>(keyMapping, dependencies): React.MutableRefObject<T>`
...
| Argument     | Type                                                                                  | Required? | Description                                                                                                                                                                                                                                         |
| ------------ | ------------------------------------------------------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| hotkeys      | [[<code>Hotkey &#124; Hotkey[]</code>](#hotkey), [`HotkeyCallback`](#hotkeycallback)] | Yes       | These are the same arguments defined in `useHotkey`, but in a mapped array form.                                                                                                                                                                    |
